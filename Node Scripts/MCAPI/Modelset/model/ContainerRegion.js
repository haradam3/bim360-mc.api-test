...
/**
* Enum class ContainerRegion.
* @enum {}
* @readonly
*/
var ContainerRegion = function () {
    function ContainerRegion() {
        _classCallCheck(this, ContainerRegion);
    ...
    _createClass(ContainerRegion, null, [{
        key: "constructFromObject",


        /**
        * Returns a <code>ContainerRegion</code> enum value from a Javascript object name.
        * @param {Object} data The plain JavaScript object containing the name of the enum value.
        * @return {module:model/ContainerRegion} The enum <code>ContainerRegion</code> value.
        */
...
exports.default = ContainerRegion;
//# sourceMappingURL=ContainerRegion.js.map