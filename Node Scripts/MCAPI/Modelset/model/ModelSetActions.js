...
var _ModelSetActionType = require('./ModelSetActionType');
...
/**
 * The ModelSetActions model module.
 * @module model/ModelSetActions
 * @version 3.0.39
 */
var ModelSetActions = function () {
  /**
   * Constructs a new <code>ModelSetActions</code>.
   * A permissions defined as a mapping between a set of Oxygen subjects and a set of ACM actions.
   * @alias module:model/ModelSetActions
   */
  function ModelSetActions() {
    _classCallCheck(this, ModelSetActions);

    ModelSetActions.initialize(this);
  }
  ...
  _createClass(ModelSetActions, null, [{
    key: 'initialize',
    value: function initialize(obj) {}

    /**
     * Constructs a <code>ModelSetActions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetActions} obj Optional instance to populate.
     * @return {module:model/ModelSetActions} The populated <code>ModelSetActions</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ModelSetActions();

        if (data.hasOwnProperty('subjects')) {
          obj['subjects'] = _ApiClient2.default.convertToType(data['subjects'], ['String']);
        }
        if (data.hasOwnProperty('actions')) {
          obj['actions'] = _ApiClient2.default.convertToType(data['actions'], [_ModelSetActionType2.default]);
        }
      }
      return obj;
    }
...
ModelSetActions.prototype['subjects'] = undefined;

/**
 * A container action associated with the subjects.
 * @member {Array.<module:model/ModelSetActionType>} actions
 */
ModelSetActions.prototype['actions'] = undefined;

exports.default = ModelSetActions;
//# sourceMappingURL=ModelSetActions.js.map