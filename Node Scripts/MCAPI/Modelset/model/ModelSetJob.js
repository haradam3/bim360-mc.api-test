...
/**
 * The ModelSetJob model module.
 * @module model/ModelSetJob
 * @version 3.0.39
 */
var ModelSetJob = function () {
  /**
   * Constructs a new <code>ModelSetJob</code>.
   * A job token representing a POST, PATCH, PUT or DELETE operation on a Model Set
   * @alias module:model/ModelSetJob
   * @param jobId {String} The Job ID
   * @param modelSetId {String} The Model Set ID associated with the Job
   * @param status {module:model/ModelSetJob.StatusEnum} The current Job status
   * @param job {module:model/Job} 
   */
  function ModelSetJob(jobId, modelSetId, status, job) {
    _classCallCheck(this, ModelSetJob);

    ModelSetJob.initialize(this, jobId, modelSetId, status, job);
  }
  ...
  _createClass(ModelSetJob, null, [{
    ...
    /**
     * Constructs a <code>ModelSetJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetJob} obj Optional instance to populate.
     * @return {module:model/ModelSetJob} The populated <code>ModelSetJob</code> instance.
     */
...
ModelSetJob.prototype['jobId'] = undefined;

/**
 * The Model Set ID associated with the Job
 * @member {String} modelSetId
 */
ModelSetJob.prototype['modelSetId'] = undefined;

/**
 * The resource associated with the job
 * @member {String} resource
 */
ModelSetJob.prototype['resource'] = undefined;

/**
 * The current Job status
 * @member {module:model/ModelSetJob.StatusEnum} status
 */
ModelSetJob.prototype['status'] = undefined;

/**
 * @member {module:model/Job} job
 */
ModelSetJob.prototype['job'] = undefined;

/**
 * @member {Array.<module:model/ResourceError>} errors
 */
ModelSetJob.prototype['errors'] = undefined;
...
exports.default = ModelSetJob;
//# sourceMappingURL=ModelSetJob.js.map