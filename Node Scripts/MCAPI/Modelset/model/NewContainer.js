...
/**
 * The NewContainer model module.
 * @module model/NewContainer
 * @version 3.0.39
 */
var NewContainer = function () {
  /**
   * Constructs a new <code>NewContainer</code>.
   * A container. If you do not supply an ID one will be created.
   * @alias module:model/NewContainer
   ...
   */
  function NewContainer(accountId, projectId) {
    _classCallCheck(this, NewContainer);

    NewContainer.initialize(this, accountId, projectId);
  }
  ...
  _createClass(NewContainer, null, [{
    key: 'initialize',
    value: function initialize(obj, accountId, projectId) {
      obj['accountId'] = accountId;
      obj['projectId'] = projectId;
    }

    /**
     * Constructs a <code>NewContainer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewContainer} obj Optional instance to populate.
     * @return {module:model/NewContainer} The populated <code>NewContainer</code> instance.
     */
...
/**
 * The GUID of this container.
 * @member {String} containerId
 */


NewContainer.prototype['containerId'] = undefined;

/**
 * The Account ID associated with this container.
 * @member {String} accountId
 */
NewContainer.prototype['accountId'] = undefined;

/**
 * The Project ID associated with this container.
 * @member {String} projectId
 */
NewContainer.prototype['projectId'] = undefined;

/**
 * @member {Array.<module:model/ContextValue>} context
 */
NewContainer.prototype['context'] = undefined;

exports.default = NewContainer;
