...
var Channel = function () {
   ...
   * A PubNub push notification channel
   * @alias module:model/Channel
   * @param channelId {String} The PubNub channel ID
   */
  function Channel(channelId) {
    _classCallCheck(this, Channel);

    Channel.initialize(this, channelId);
  }
  ...
  _createClass(Channel, null, [{
    key: 'initialize',
    value: function initialize(obj, channelId) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('channelId')) {
          obj['channelId'] = _ApiClient2.default.convertToType(data['channelId'], 'String');
        }
      }
      return obj;
    }
