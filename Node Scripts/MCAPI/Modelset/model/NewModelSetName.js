...
/**
 * The NewModelSetName model module.
 * @module model/NewModelSetName
 * @version 3.0.39
 */
var NewModelSetName = function () {
  /**
   * Constructs a new <code>NewModelSetName</code>.
   * A request for changing the display text associated with a model set.
   * @alias module:model/NewModelSetName
   */
  function NewModelSetName() {
    _classCallCheck(this, NewModelSetName);

    NewModelSetName.initialize(this);
  }
  ...
  _createClass(NewModelSetName, null, [{
    key: 'initialize',
    value: function initialize(obj) {}

    /**
     * Constructs a <code>NewModelSetName</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewModelSetName} obj Optional instance to populate.
     * @return {module:model/NewModelSetName} The populated <code>NewModelSetName</code> instance.
     */
  ...
  return NewModelSetName;
}();

/**
 * The previous name of the Model Set. This name must be unique within the specified Container
 * @member {String} oldName
 */


NewModelSetName.prototype['oldName'] = undefined;

/**
 * A textual description of the model set.
 * @member {String} oldDescription
 */
NewModelSetName.prototype['oldDescription'] = undefined;

/**
 * The previous name of the Model Set. This name must be unique within the specified Container
 * @member {String} newName
 */
NewModelSetName.prototype['newName'] = undefined;

/**
 * A textual description of the model set.
 * @member {String} newDescription
 */
NewModelSetName.prototype['newDescription'] = undefined;

exports.default = NewModelSetName;
//# sourceMappingURL=NewModelSetName.js.map