...
var _ModelSetActions = require('./ModelSetActions');
...
/**
 * The ModelSetPermissionCollection model module.
 * @module model/ModelSetPermissionCollection
 * @version 3.0.39
 */
var ModelSetPermissionCollection = function () {
  /**
   * Constructs a new <code>ModelSetPermissionCollection</code>.
   * A set of permissions for a container.
   * @alias module:model/ModelSetPermissionCollection
   */
  function ModelSetPermissionCollection() {
    _classCallCheck(this, ModelSetPermissionCollection);

    ModelSetPermissionCollection.initialize(this);
  }
  ...
  _createClass(ModelSetPermissionCollection, null, [{
    key: 'initialize',
    value: function initialize(obj) {}

    /**
     * Constructs a <code>ModelSetPermissionCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetPermissionCollection} obj Optional instance to populate.
     * @return {module:model/ModelSetPermissionCollection} The populated <code>ModelSetPermissionCollection</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ModelSetPermissionCollection();

        if (data.hasOwnProperty('permissions')) {
          obj['permissions'] = _ApiClient2.default.convertToType(data['permissions'], [_ModelSetActions2.default]);
        }
      }
      return obj;
    }
  ...
  return ModelSetPermissionCollection;
}();

/**
 * A set of permissions defined as a mapping between a set of Oxygen subjects and a set of ACM actions
 * @member {Array.<module:model/ModelSetActions>} permissions
 */


ModelSetPermissionCollection.prototype['permissions'] = undefined;

exports.default = ModelSetPermissionCollection;
//# sourceMappingURL=ModelSetPermissionCollection.js.map