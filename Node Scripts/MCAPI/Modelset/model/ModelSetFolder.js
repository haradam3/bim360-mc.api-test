...
/**
 * The ModelSetFolder model module.
 * @module model/ModelSetFolder
 * @version 3.0.39
 */
var ModelSetFolder = function () {
  /**
   * Constructs a new <code>ModelSetFolder</code>.
   * A folder and optional filters which will define a set of documents.
   * @alias module:model/ModelSetFolder
   * @param folderUrn {String} The WIP URN of the folder.
   */
  function ModelSetFolder(folderUrn) {
    _classCallCheck(this, ModelSetFolder);

    ModelSetFolder.initialize(this, folderUrn);
  }
  ...
  _createClass(ModelSetFolder, null, [{
    key: 'initialize',
    value: function initialize(obj, folderUrn) {
      obj['folderUrn'] = folderUrn;
    }

    /**
     * Constructs a <code>ModelSetFolder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetFolder} obj Optional instance to populate.
     * @return {module:model/ModelSetFolder} The populated <code>ModelSetFolder</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ModelSetFolder();

        if (data.hasOwnProperty('folderUrn')) {
          obj['folderUrn'] = _ApiClient2.default.convertToType(data['folderUrn'], 'String');
        }
        if (data.hasOwnProperty('documentFilters')) {
          obj['documentFilters'] = _ApiClient2.default.convertToType(data['documentFilters'], ['String']);
        }
      }
      return obj;
    }
  ...
  return ModelSetFolder;
}();

/**
 * The WIP URN of the folder.
 * @member {String} folderUrn
 */


ModelSetFolder.prototype['folderUrn'] = undefined;

/**
 * A set of document name filters to apply on the folder contents to determine the documents in the model set. If no filters are supplied then a default of *.* is assumed.
 * @member {Array.<String>} documentFilters
 */
ModelSetFolder.prototype['documentFilters'] = undefined;

exports.default = ModelSetFolder;
//# sourceMappingURL=ModelSetFolder.js.map