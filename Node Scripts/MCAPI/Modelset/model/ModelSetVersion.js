...
/**
 * The ModelSetVersion model module.
 * @module model/ModelSetVersion
 * @version 3.0.39
 */
var ModelSetVersion = function () {
  /**
   * Constructs a new <code>ModelSetVersion</code>.
   * A version of a model set, representing the contents of the model set at a point in time.
   * @alias module:model/ModelSetVersion
   ...
   * @param status {module:model/ModelSetVersion.StatusEnum} The creation status of the model set version
   ...
   */
  function ModelSetVersion(modelSetId, version, createTime, status, documentVersions) {
    _classCallCheck(this, ModelSetVersion);

    ModelSetVersion.initialize(this, modelSetId, version, createTime, status, documentVersions);
  }
  ...
  _createClass(ModelSetVersion, null, [{
    key: 'initialize',
    value: function initialize(obj, modelSetId, version, createTime, status, documentVersions) {
    ...
    /**
     * Constructs a <code>ModelSetVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetVersion} obj Optional instance to populate.
     * @return {module:model/ModelSetVersion} The populated <code>ModelSetVersion</code> instance.
     */
...
ModelSetVersion.prototype['modelSetId'] = undefined;

/**
 * The version number.
 * @member {Number} version
 */
ModelSetVersion.prototype['version'] = undefined;

/**
 * The date and time that the model set version was created.
 * @member {Date} createTime
 */
ModelSetVersion.prototype['createTime'] = undefined;

/**
 * The creation status of the model set version
 * @member {module:model/ModelSetVersion.StatusEnum} status
 */
ModelSetVersion.prototype['status'] = undefined;
 ...
 */
ModelSetVersion.prototype['documentVersions'] = undefined;
...
exports.default = ModelSetVersion;
//# sourceMappingURL=ModelSetVersion.js.map