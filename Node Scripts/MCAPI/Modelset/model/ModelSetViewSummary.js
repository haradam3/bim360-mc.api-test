...
/**
 * The ModelSetViewSummary model module.
 * @module model/ModelSetViewSummary
 * @version 3.0.39
 */
var ModelSetViewSummary = function () {
  /**
   * Constructs a new <code>ModelSetViewSummary</code>.
   * A model set view
   * @alias module:model/ModelSetViewSummary
   ...
   */
  function ModelSetViewSummary(name, isPrivate, documentLineageUrns) {
    _classCallCheck(this, ModelSetViewSummary);

    ModelSetViewSummary.initialize(this, name, isPrivate, documentLineageUrns);
  }
  ...
  _createClass(ModelSetViewSummary, null, [{
    key: 'initialize',
    ...
    /**
     * Constructs a <code>ModelSetViewSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetViewSummary} obj Optional instance to populate.
     * @return {module:model/ModelSetViewSummary} The populated <code>ModelSetViewSummary</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ModelSetViewSummary();
...
ModelSetViewSummary.prototype['name'] = undefined;

/**
 * The view description
 * @member {String} description
 */
ModelSetViewSummary.prototype['description'] = undefined;

/**
 * The view is only accessible to its creator
 * @member {Boolean} isPrivate
 */
ModelSetViewSummary.prototype['isPrivate'] = undefined;

/**
 * The list of document lineage URNs
 * @member {Array.<String>} documentLineageUrns
 */
ModelSetViewSummary.prototype['documentLineageUrns'] = undefined;

/**
 * A view screenshot Id
 * @member {String} screenshotId
 */
ModelSetViewSummary.prototype['screenshotId'] = undefined;

exports.default = ModelSetViewSummary;
//# sourceMappingURL=ModelSetViewSummary.js.map