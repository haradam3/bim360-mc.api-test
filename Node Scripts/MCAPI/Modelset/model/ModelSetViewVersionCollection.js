...
var _ModelSetViewVersion = require('./ModelSetViewVersion');
...
/**
 * The ModelSetViewVersionCollection model module.
 * @module model/ModelSetViewVersionCollection
 * @version 3.0.39
 */
var ModelSetViewVersionCollection = function () {
  /**
   * Constructs a new <code>ModelSetViewVersionCollection</code>.
   * A response for getting model set versions.
   * @alias module:model/ModelSetViewVersionCollection
   */
  function ModelSetViewVersionCollection() {
    _classCallCheck(this, ModelSetViewVersionCollection);

    ModelSetViewVersionCollection.initialize(this);
  }
  ...
  _createClass(ModelSetViewVersionCollection, null, [{
    key: 'initialize',
    value: function initialize(obj) {}

    /**
     * Constructs a <code>ModelSetViewVersionCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetViewVersionCollection} obj Optional instance to populate.
     * @return {module:model/ModelSetViewVersionCollection} The populated <code>ModelSetViewVersionCollection</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ModelSetViewVersionCollection();

        if (data.hasOwnProperty('page')) {
          obj['page'] = _CollectionPage2.default.constructFromObject(data['page']);
        }
        if (data.hasOwnProperty('modelSetViewVersions')) {
          obj['modelSetViewVersions'] = _ApiClient2.default.convertToType(data['modelSetViewVersions'], [_ModelSetViewVersion2.default]);
        }
      }
      return obj;
    }
  ...
  return ModelSetViewVersionCollection;
}();
...
ModelSetViewVersionCollection.prototype['page'] = undefined;

/**
 * List of model set view versions.
 * @member {Array.<module:model/ModelSetViewVersion>} modelSetViewVersions
 */
ModelSetViewVersionCollection.prototype['modelSetViewVersions'] = undefined;

exports.default = ModelSetViewVersionCollection;
//# sourceMappingURL=ModelSetViewVersionCollection.js.map