...
var _ModelSetSummary = require('./ModelSetSummary');
...
/**
 * The ModelSetSummaryCollection model module.
 * @module model/ModelSetSummaryCollection
 * @version 3.0.39
 */
var ModelSetSummaryCollection = function () {
  /**
   * Constructs a new <code>ModelSetSummaryCollection</code>.
   * A response for getting model sets.
   * @alias module:model/ModelSetSummaryCollection
   * @param page {module:model/CollectionPage} 
   * @param modelSets {Array.<module:model/ModelSetSummary>} List of model set summaries.
   */
  function ModelSetSummaryCollection(page, modelSets) {
    _classCallCheck(this, ModelSetSummaryCollection);

    ModelSetSummaryCollection.initialize(this, page, modelSets);
  }
  ...
  _createClass(ModelSetSummaryCollection, null, [{
    key: 'initialize',
    value: function initialize(obj, page, modelSets) {
      obj['page'] = page;
      obj['modelSets'] = modelSets;
    }

    /**
     * Constructs a <code>ModelSetSummaryCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetSummaryCollection} obj Optional instance to populate.
     * @return {module:model/ModelSetSummaryCollection} The populated <code>ModelSetSummaryCollection</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ModelSetSummaryCollection();

        if (data.hasOwnProperty('page')) {
          obj['page'] = _CollectionPage2.default.constructFromObject(data['page']);
        }
        if (data.hasOwnProperty('modelSets')) {
          obj['modelSets'] = _ApiClient2.default.convertToType(data['modelSets'], [_ModelSetSummary2.default]);
        }
      }
      return obj;
    }
  ...
  return ModelSetSummaryCollection;
}();
...
ModelSetSummaryCollection.prototype['page'] = undefined;

/**
 * List of model set summaries.
 * @member {Array.<module:model/ModelSetSummary>} modelSets
 */
ModelSetSummaryCollection.prototype['modelSets'] = undefined;

exports.default = ModelSetSummaryCollection;
//# sourceMappingURL=ModelSetSummaryCollection.js.map