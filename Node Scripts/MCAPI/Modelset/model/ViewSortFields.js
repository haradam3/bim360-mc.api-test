...
/**
* Enum class ViewSortFields.
* @enum {}
* @readonly
*/
var ViewSortFields = function () {
    function ViewSortFields() {
        _classCallCheck(this, ViewSortFields);
    ...
    _createClass(ViewSortFields, null, [{
        key: "constructFromObject",


        /**
        * Returns a <code>ViewSortFields</code> enum value from a Javascript object name.
        * @param {Object} data The plain JavaScript object containing the name of the enum value.
        * @return {module:model/ViewSortFields} The enum <code>ViewSortFields</code> value.
        */
    ...
    return ViewSortFields;
}();

exports.default = ViewSortFields;
//# sourceMappingURL=ViewSortFields.js.map