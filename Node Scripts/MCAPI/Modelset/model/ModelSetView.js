...
/**
 * The ModelSetView model module.
 * @module model/ModelSetView
 * @version 3.0.39
 */
var ModelSetView = function () {
  /**
   * Constructs a new <code>ModelSetView</code>.
   * A model set view
   * @alias module:model/ModelSetView
   ...
   */
  function ModelSetView(name, isPrivate, documentLineageUrns) {
    _classCallCheck(this, ModelSetView);

    ModelSetView.initialize(this, name, isPrivate, documentLineageUrns);
  }
  ...
  _createClass(ModelSetView, null, [{
    key: 'initialize',
    ...
    /**
     * Constructs a <code>ModelSetView</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetView} obj Optional instance to populate.
     * @return {module:model/ModelSetView} The populated <code>ModelSetView</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('modifiedBy')) {
          obj['modifiedBy'] = _ApiClient2.default.convertToType(data['modifiedBy'], 'String');
        }
        if (data.hasOwnProperty('modifiedTime')) {
          obj['modifiedTime'] = _ApiClient2.default.convertToType(data['modifiedTime'], 'Date');
        }
      }
      return obj;
    }
...
ModelSetView.prototype['name'] = undefined;

/**
 * The view description
 * @member {String} description
 */
ModelSetView.prototype['description'] = undefined;

/**
 * The view is only accessible to its creator
 * @member {Boolean} isPrivate
 */
ModelSetView.prototype['isPrivate'] = undefined;

/**
 * The list of document lineage URNs
 * @member {Array.<String>} documentLineageUrns
 */
ModelSetView.prototype['documentLineageUrns'] = undefined;

/**
 * A view screenshot Id
 * @member {String} screenshotId
 */
ModelSetView.prototype['screenshotId'] = undefined;

/**
 * The ID of this view.
 * @member {String} viewId
 */
ModelSetView.prototype['viewId'] = undefined;

/**
 * The Oxygen ID of the user or service which created this model set view.
 * @member {String} createdBy
 */
ModelSetView.prototype['createdBy'] = undefined;

/**
 * The date and time this model set view was created.
 * @member {Date} createdTime
 */
ModelSetView.prototype['createdTime'] = undefined;

/**
 * The Oxygen ID of the user or service which modified this model set view.
 * @member {String} modifiedBy
 */
ModelSetView.prototype['modifiedBy'] = undefined;

/**
 * The date and time this model set view was modified.
 * @member {Date} modifiedTime
 */
ModelSetView.prototype['modifiedTime'] = undefined;

exports.default = ModelSetView;
//# sourceMappingURL=ModelSetView.js.map