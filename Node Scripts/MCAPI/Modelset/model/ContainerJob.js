...
/**
 * The ContainerJob model module.
 * @module model/ContainerJob
 * @version 3.0.39
 */
var ContainerJob = function () {
  /**
   * Constructs a new <code>ContainerJob</code>.
   * A job token representing a POST, PATCH, PUT or DELETE operation on a Container
   * @alias module:model/ContainerJob
   * @param jobId {String} The Job ID
   * @param containerId {String} The Container ID associated with the Job
   * @param status {module:model/ContainerJob.StatusEnum} The current Job status
   * @param job {module:model/Job} 
   */
  function ContainerJob(jobId, containerId, status, job) {
    _classCallCheck(this, ContainerJob);

    ContainerJob.initialize(this, jobId, containerId, status, job);
  }
  ...
  _createClass(ContainerJob, null, [{
    key: 'initialize',
    value: function initialize(obj, jobId, containerId, status, job) {
      obj['jobId'] = jobId;
    ...
    /**
     * Constructs a <code>ContainerJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContainerJob} obj Optional instance to populate.
     * @return {module:model/ContainerJob} The populated <code>ContainerJob</code> instance.
     */
...
ContainerJob.prototype['jobId'] = undefined;

/**
 * The Container ID associated with the Job
 * @member {String} containerId
 */
ContainerJob.prototype['containerId'] = undefined;

/**
 * The current Job status
 * @member {module:model/ContainerJob.StatusEnum} status
 */
ContainerJob.prototype['status'] = undefined;

/**
 * @member {module:model/Job} job
 */
ContainerJob.prototype['job'] = undefined;

/**
 * @member {Array.<module:model/ResourceError>} errors
 */
ContainerJob.prototype['errors'] = undefined;
...
exports.default = ContainerJob;
//# sourceMappingURL=ContainerJob.js.map