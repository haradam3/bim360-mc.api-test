...
/**
* Enum class ModelSetActionType.
* @enum {}
* @readonly
*/
var ModelSetActionType = function () {
    function ModelSetActionType() {
        _classCallCheck(this, ModelSetActionType);
    ...
    _createClass(ModelSetActionType, null, [{
        key: "constructFromObject",


        /**
        * Returns a <code>ModelSetActionType</code> enum value from a Javascript object name.
        * @param {Object} data The plain JavaScript object containing the name of the enum value.
        * @return {module:model/ModelSetActionType} The enum <code>ModelSetActionType</code> value.
        */
    ...
    return ModelSetActionType;
}();

exports.default = ModelSetActionType;
//# sourceMappingURL=ModelSetActionType.js.map