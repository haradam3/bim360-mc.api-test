...
var _ModelSetVersionSummary = require('./ModelSetVersionSummary');
...
/**
 * The ModelSetVersionSummaryCollection model module.
 * @module model/ModelSetVersionSummaryCollection
 * @version 3.0.39
 */
var ModelSetVersionSummaryCollection = function () {
  /**
   * Constructs a new <code>ModelSetVersionSummaryCollection</code>.
   * A response for getting model set versions.
   * @alias module:model/ModelSetVersionSummaryCollection
   * @param modelSetVersions {Array.<module:model/ModelSetVersionSummary>} List of model set version summaries.
   */
  function ModelSetVersionSummaryCollection(modelSetVersions) {
    _classCallCheck(this, ModelSetVersionSummaryCollection);

    ModelSetVersionSummaryCollection.initialize(this, modelSetVersions);
  }
  ...
  _createClass(ModelSetVersionSummaryCollection, null, [{
    key: 'initialize',
    value: function initialize(obj, modelSetVersions) {
      obj['modelSetVersions'] = modelSetVersions;
    }

    /**
     * Constructs a <code>ModelSetVersionSummaryCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelSetVersionSummaryCollection} obj Optional instance to populate.
     * @return {module:model/ModelSetVersionSummaryCollection} The populated <code>ModelSetVersionSummaryCollection</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ModelSetVersionSummaryCollection();

        if (data.hasOwnProperty('page')) {
          obj['page'] = _CollectionPage2.default.constructFromObject(data['page']);
        }
        if (data.hasOwnProperty('modelSetVersions')) {
          obj['modelSetVersions'] = _ApiClient2.default.convertToType(data['modelSetVersions'], [_ModelSetVersionSummary2.default]);
        }
      }
      return obj;
    }
  ...
  return ModelSetVersionSummaryCollection;
}();
...
ModelSetVersionSummaryCollection.prototype['page'] = undefined;

/**
 * List of model set version summaries.
 * @member {Array.<module:model/ModelSetVersionSummary>} modelSetVersions
 */
ModelSetVersionSummaryCollection.prototype['modelSetVersions'] = undefined;

exports.default = ModelSetVersionSummaryCollection;
//# sourceMappingURL=ModelSetVersionSummaryCollection.js.map