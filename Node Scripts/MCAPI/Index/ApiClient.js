...
var ApiClient = function () {
    function ApiClient() {
         ...
         * @type {String}
         * @default https://virtserver.swaggerhub.com/autodesk/bim360-nucleus-index
         */
        this.basePath = 'https://developer.api.autodesk.com/bim360/modelset-index'.replace(/\/+$/, '');
        ...
        this.authentications = {
            ...
            'oauth2CientCredentials': { type: 'oauth2' }
